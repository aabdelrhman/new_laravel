        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <!-- menu item Section-->
                    <li>
                        @permission('show-section')
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Section">
                            <div class="pull-left"><i class="ti-palette"></i><span
                                    class="right-nav-text">{{__('messages.section_title')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Section" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{Route('section.index')}}">{{__('messages.section_title')}}</a></li>
                            @permission('create-section')
                            <li><a href="{{Route('section.create')}}">{{__('messages.sectionAdd')}}</a></li>
                            @endrole
                        </ul>
                        @endpermission
                    </li>
                    <!-- menu item Brand-->
                    <li>
                        @permission('show-brand')
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Brand">
                            <div class="pull-left"><i class="ti-calendar"></i><span
                                    class="right-nav-text">{{ __('messages.Brands Title') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Brand" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ Route('brand.index') }}">{{ __('messages.Brands Title') }} </a> </li>
                            @permission('create-brand')
                            <li> <a href="{{ Route('brand.create') }}">{{ __('messages.Brand add') }}</a> </li>
                            @endpermission
                        </ul>
                        @endpermission
                    </li>
                    ...
                    <li>
                        ...
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Product">
                            <div class="pull-left"><i class="ti-pie-chart"></i><span
                                    class="right-nav-text">{{ __('messages.Product title') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Product" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ Route('product.index') }}">{{__('messages.Product title')}}</a> </li>
                            @permission('create-product')
                            <li> <a href="{{ Route('product.create') }}">{{__('messages.Product add')}} </a> </li>
                            @endpermission
                            <li> <a href="{{ Route('product.archif') }}">{{__('messages.Product Archif')}} </a> </li>
                        </ul>
                        @endpermission
                    </li>
                    <!-- menu item Admin And Roles-->
                    <li>
                        @permission('show-role')
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Admin">
                            <div class="pull-left"><i class="ti-pie-chart"></i><span
                                    class="right-nav-text">{{ __('messages.Admin Roles') }}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Admin" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ Route('roles.index') }}">{{__('messages.Roles')}}</a> </li>
                            @permission('create-role')
                            <li> <a href="{{ Route('roles.create') }}">{{__('messages.Roles add')}} </a> </li>
                            @endpermission
                        </ul>
                        @endpermission
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#admins">
                            <div class="pull-left"><i class="ti-files"></i><span class="right-nav-text">{{__('messages.Admins title')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="admins" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{ Route('admins.index') }}">{{__('messages.Admins title')}}</a> </li>
                            <li> <a href="{{ Route('admins.create') }}">{{__('messages.Admins add')}}</a> </li>
                        </ul>
                    </li>
                    <!-- menu item Offers-->
                    <li>
                        <a href="{{ Route('offers.index') }}"><i class="ti-menu-alt"></i><span class="right-nav-text">{{__('messages.offers')}}</span> </a>
                    </li>
                    <!-- menu item chat-->
                    <li>
