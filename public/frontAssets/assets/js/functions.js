;(function($) {
    ...
    if($(".timer").length > 0){
        $(".timer").each( function(index, el){
            ...
            var countDownDate = new Date(_expire).getTime();
            ...
            _this.html('<span><b>'+days+'</b> Days</span> <span><b>'+hours+'</b> Hrs</span> <span><b>'+minutes+'</b> Mins</span> <span><b>'+seconds+'</b> Secs</span>');
            if (distance < 0) {
                clearInterval(x);
